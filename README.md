...
### The wall
The front-end for the "wall" is built using [Backbone.js](http://documentcloud.github.com/backbone/). The wall receives its data through socket.io. If the user also entered their twitter username, information from their twitter account is pulled and displayed on the wall.
